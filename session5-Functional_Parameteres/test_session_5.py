...
def test_readme_exists():
    assert os.path.isfile("session5-Functional_Parameteres/README.md"), "README.md file missing!"

def test_readme_contents():
    readme = open("session5-Functional_Parameteres/README.md", "r", encoding="utf-8")
...
def test_readme_proper_description():
    ...
    f = open("session5-Functional_Parameteres/README.md", "r", encoding="utf-8")
    content = f.read()
    f.close()
